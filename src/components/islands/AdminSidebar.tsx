    ...
    return (
        <nav className="flex-1 px-3 py-6 space-y-2 overflow-y-auto custom-scrollbar">
            ...
            <div className="mt-auto pt-10">
                <a href={SITE_URL} target="_blank" className="flex items-center px-4 py-3 text-xs font-semibold text-slate-500 hover:text-white border-t border-white/5 group transition-colors" title={isCollapsed ? "Ver Tienda" : ""}>
